...
console.log("URL =https://qytwrhsdjuymaoyfufzo.supabase.co", process.env.SUPABASE_URL);
console.log("KEY =sb_publishable_mdI0yeEjWK6kKiLr4EUkmA_ZzgXQzvj", process.env.SUPABASE_KEY);
